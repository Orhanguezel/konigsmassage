-- =============================================================
-- FILE: 161_footer_sections_seed.sql (KÖNIGS MASSAGE — FINAL)
-- footer_sections + footer_sections_i18n (tr, en, de)
-- Sections: Quick Access, Massage Types, Legal, Social
-- Idempotent seed
-- =============================================================
...
(UUID(),'a0e2b2a9-7f0d-4f30-9a64-3ed7bd1d3c10','tr','Masaj Çeşitleri','masaj-cesitleri','Evde masaj hizmetlerimiz ve seans seçenekleri.','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
...
(UUID(),'a0e2b2a9-7f0d-4f30-9a64-3ed7bd1d3c10','en','Massage Types','massage-types','Our at-home massage services and session options.','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
...
(UUID(),'a0e2b2a9-7f0d-4f30-9a64-3ed7bd1d3c10','de','Massagearten','massagearten','Unsere Hausmassage-Services und Sitzungsoptionen.','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
