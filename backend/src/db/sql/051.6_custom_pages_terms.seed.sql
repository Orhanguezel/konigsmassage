-- =============================================================
-- FILE: 051.6_custom_pages_terms.seed.sql (FINAL — Königsmassage, rerunnable)
-- Königsmassage – Custom Page: Terms / Nutzungsbedingungen (TR/EN/DE)
      ...
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">',
            'Bu koşullar, Königs Massage web sitesinin kullanımına ilişkin kuralları ve tarafların hak/yükümlülüklerini düzenler. ',
        ...
        '<div class="grid md:grid-cols-2 gap-6 mb-6">',
          '<div class="bg-white border border-slate-200 rounded-2xl p-6">',
            ...
            '<p class="text-slate-700 mb-3">',
              'Sitedeki metin, görsel, logo ve diğer tüm materyaller Königs Massage’a veya hak sahiplerine aittir.',
            '</p>',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700 mb-3">',
            'Sitede yer alan bilgiler genel bilgilendirme amaçlıdır. Königs Massage, içeriğin doğruluğu ve güncelliği için makul çaba gösterir; ',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">',
            'Üçüncü taraf sitelere verilen bağlantılar bilgi amaçlıdır. Königs Massage bu sitelerin içeriğinden ve uygulamalarından sorumlu değildir.',
          '</p>',
        '</div>',
        ...
        '<div class="bg-slate-900 text-white rounded-2xl p-6">',
          ...
          '<p class="text-white/90">',
            'Königs Massage, kullanım koşullarını güncelleme hakkını saklı tutar. Güncellemeler web sitesinde yayımlandığı tarihten itibaren geçerlidir.',
          '</p>',
        '</div>',
      '</section>'
    )
  ),
  'Königs Massage Kullanım Koşulları: web sitesi kullanımı, fikri mülkiyet, kullanıcı yükümlülükleri, randevu süreçleri, sorumluluk sınırları ve değişiklik hükümleri.',
  'Königs Massage Kullanım Koşulları sayfası',
  'Kullanım Koşulları | Königs Massage',
  'Königs Massage web sitesi kullanım koşulları: içerik hakları, kullanıcı yükümlülükleri, randevu süreçleri, sorumluluk reddi ve üçüncü taraf bağlantılar.',
  'konigsmassage,legal,kullanim kosullari,terms,fikri mulkiyet,randevu,sorumluluk',
  NOW(3), NOW(3)
),
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">',
            'These terms govern the use of the Königs Massage website. Website content is provided for general informational purposes and does not constitute medical advice.',
          '</p>',
        '</div>',
        ...
        '<div class="grid md:grid-cols-2 gap-6 mb-6">',
          '<div class="bg-white border border-slate-200 rounded-2xl p-6">',
            ...
            '<p class="text-slate-700 mb-3">',
              'Texts, images, logos and all materials are owned by Königs Massage or respective rights holders.',
            '</p>',
            '<ul class="list-disc pl-6 text-slate-700 space-y-2">',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700 mb-3">',
            'Content is provided “as is” for general information. Königs Massage makes reasonable efforts to keep information accurate and up to date, but provides no warranty.',
          '</p>',
          '<p class="text-slate-700">',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">',
            'Links to third-party websites are provided for convenience. Königs Massage is not responsible for third-party content or practices.',
          '</p>',
        '</div>',
        ...
        '<div class="bg-slate-900 text-white rounded-2xl p-6">',
          ...
          '<p class="text-white/90">',
            'Königs Massage may update these terms. Changes take effect upon publication on this website.',
          '</p>',
        '</div>',
      '</section>'
    )
  ),
  'Königs Massage Terms of Use: website usage, intellectual property, user obligations, booking rules, disclaimer and updates.',
  'Königs Massage Terms of Use page',
  'Terms of Use | Königs Massage',
  'Königs Massage Terms of Use covers IP, user obligations, appointment rules, disclaimers, external links and changes.',
  'konigsmassage,legal,terms of use,appointments,disclaimer,intellectual property',
  NOW(3), NOW(3)
),
...
(
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">',
            'Diese Bedingungen regeln die Nutzung der Website von Königs Massage. Inhalte dienen der allgemeinen Information und stellen keine medizinische Beratung dar.',
          '</p>',
        '</div>',
        ...
        '<div class="grid md:grid-cols-2 gap-6 mb-6">',
          '<div class="bg-white border border-slate-200 rounded-2xl p-6">',
            ...
            '<p class="text-slate-700 mb-3">',
              'Texte, Bilder, Logos und Materialien sind Eigentum von Königs Massage bzw. der jeweiligen Rechteinhaber.',
            '</p>',
            '<ul class="list-disc pl-6 text-slate-700 space-y-2">',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700 mb-3">',
            'Inhalte werden „wie gesehen“ bereitgestellt. Königs Massage bemüht sich um Aktualität, übernimmt jedoch keine Gewähr.',
          '</p>',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">Für Inhalte verlinkter Drittseiten übernimmt Königs Massage keine Verantwortung.</p>',
        '</div>',

        '<div class="bg-slate-900 text-white rounded-2xl p-6">',
          '<h2 class="text-xl font-semibold mb-3">7. Änderungen</h2>',
          '<p class="text-white/90">Königs Massage kann diese Bedingungen aktualisieren. Änderungen gelten ab Veröffentlichung.</p>',
        '</div>',
      '</section>'
    )
  ),
  'Königs Massage Nutzungsbedingungen: Website-Nutzung, Urheberrechte, Pflichten, Terminregeln, Haftungsausschluss und Änderungen.',
  'Königs Massage Nutzungsbedingungen',
  'Nutzungsbedingungen | Königs Massage',
  ...
  'konigsmassage,legal,nutzungsbedingungen,termine,haftung,urheberrecht',
  NOW(3), NOW(3)
)
ON DUPLICATE KEY UPDATE
