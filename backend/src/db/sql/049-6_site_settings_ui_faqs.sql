...
-- Königs Massage – UI FAQ / SSS (site_settings.ui_faqs) [FINAL]
...
(
  ...
  CAST(
    JSON_OBJECT(
      'ui_faqs_subprefix',            'Königs Massage',
      ...
      'ui_faqs_cover_alt',            'Königs Massage SSS kapak görseli',
      ...
      'ui_faqs_kicker_prefix',        'Königs Massage',
      'ui_faqs_kicker_label',         'Sıkça Sorulan Sorular',

      'ui_faqs_empty',                'Şu anda görüntülenecek soru bulunmamaktadır.',
      'ui_faqs_intro',                'Königs Massage seansları, randevu süreci ve genel uygulamalar hakkında sık sorulan soruların yanıtlarını burada bulabilirsiniz.',
      ...
      'ui_faqs_page_description',     'Königs Massage hakkında sıkça sorulan sorular ve cevapları.',
      'ui_faqs_meta_title',           'SSS | Königs Massage',
      'ui_faqs_meta_description',     'Königs Massage: seanslar, randevu, iptal/erteleme ve uygulama detayları hakkında sıkça sorulan sorular.',
      'ui_faqs_og_image',             ''
    )
...
(
  ...
  CAST(
    JSON_OBJECT(
      ...
      'ui_faqs_cover_alt',            'Königs Massage FAQ cover image',
      ...
      'ui_faqs_intro',                'Find answers to common questions about Königs Massage sessions, booking, and general practices.',
      ...
      'ui_faqs_page_description',     'Frequently asked questions and answers about Königs Massage.',
      'ui_faqs_meta_title',           'FAQs | Königs Massage',
      'ui_faqs_meta_description',     'Königs Massage FAQs: sessions, booking, cancellations/rescheduling, and practical details.',
      'ui_faqs_og_image',             ''
    )
    AS CHAR CHARACTER SET utf8mb4
  ),
...
(
  ...
  CAST(
    JSON_OBJECT(
      ...
      'ui_faqs_cover_alt',            'Königs Massage FAQ Titelbild',
      ...
      'ui_faqs_intro',                'Hier finden Sie Antworten auf häufige Fragen zu Königs Massage Behandlungen, Buchung und allgemeinen Abläufen.',
      ...
      'ui_faqs_page_description',     'Häufig gestellte Fragen und Antworten über Königs Massage.',
      'ui_faqs_meta_title',           'FAQs | Königs Massage',
      'ui_faqs_meta_description',     'Königs Massage FAQs: Behandlungen, Buchung, Absage/Verschieben und praktische Informationen.',
      'ui_faqs_og_image',             ''
    )
    AS CHAR CHARACTER SET utf8mb4
  ),
