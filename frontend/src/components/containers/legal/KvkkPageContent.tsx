// =============================================================
// FILE: src/components/containers/legal/KvkkPageContent.tsx
// konigsmassage – KVKK Content (SINGLE PAGE) (I18N + SAFE)
// Data: custom_pages (module_key="kvkk") -> first published
// - Locale aware query
...
const KvkkPageContent: React.FC = () => {
  ...
  const title = useMemo(() => {
    ...
    return t || String(ui('ui_kvkk_fallback_title', 'KVKK') || '').trim() || 'KVKK';
  }, [page, ui]);
          ...
          <div className="row">
            <div className="col-12">
              <div className="alert alert-warning">
                {ui('ui_kvkk_empty', 'KVKK content not found.')}
              </div>
            </div>
          </div>
        )}
          ...
          <div className="row">
            <div className="col-12">
              ...
              {html ? (
                ...
                <div className="alert alert-warning">
                  {ui('ui_kvkk_empty_text', 'KVKK içeriği yakında yayınlanacaktır.')}
                </div>
              )}
