// =============================================================
// FILE: src/components/containers/legal/CookiePolicyPageContent.tsx
// konigsmassage – Cookie Policy Content (SINGLE PAGE) (I18N + SAFE)
// Data: custom_pages (module_key="cookies") -> first published
// - Locale aware query
...
const CookiePolicyPageContent: React.FC = () => {
  ...
  // Tailwind-like classes used in seed content; keep it minimal & safe.
          ...
          <div className="row">
            <div className="col-12">
              <div className="alert alert-warning">
                {ui('ui_cookie_policy_empty', 'Cookie policy content not found.')}
              </div>
            </div>
          </div>
        )}
        ...
        {!!page && !isLoading && (
          <div className="row">
            <div className="col-12">
              ...
              {/* Seed içeriği kendi container’ını yazıyor; gene de wrapper ile güvenli hale getiriyoruz */}
              {html ? (
                ...
                <div className="alert alert-warning">
                  {ui(
                    ...
                    'Çerez politikası içeriği yakında yayınlanacaktır.',
                  )}
                </div>
              )}

              {/* İçerik title’ını banner zaten basıyor; ama gerekirse burada da kullanılabilir */}
