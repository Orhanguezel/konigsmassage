// =============================================================
// FILE: src/components/containers/legal/TermsPageContent.tsx
// konigsmassage – Terms Content (SINGLE PAGE) (I18N + SAFE)
// Data: custom_pages (module_key="terms") -> first published
// - Locale aware query
          ...
          <div className="row">
            <div className="col-12">
              <div className="alert alert-warning">
                {ui('ui_terms_empty', 'Terms content not found.')}
              </div>
            </div>
          </div>
        )}
          ...
          <div className="row">
            <div className="col-12">
              ...
              {html ? (
                ...
                <div className="alert alert-warning">
                  {ui('ui_terms_empty_text', 'Kullanım koşulları içeriği yakında yayınlanacaktır.')}
                </div>
              )}
