...
const TermsPageContent: React.FC = () => {
  ...
  const title = useMemo(() => {
    ...
    return t || String(ui('ui_terms_fallback_title', 'Terms & Conditions') || '').trim() || 'Terms & Conditions';
  }, [page, ui]);
        ...
        {!isLoading && (isError || !page) && (
          <div className="max-w-4xl mx-auto">
              <div className="bg-sand-50 border border-sand-200 text-brand-dark px-6 py-4 rounded-xl" role="alert">
                {ui('ui_terms_empty', 'Content not found.')}
              </div>
          </div>
        )}
        ...
        {!!page && !isLoading && (
          <div className="max-w-4xl mx-auto">
              ...
              {html ? (
                ...
                <div className="bg-sand-50 border border-sand-200 text-brand-dark px-6 py-4 rounded-xl" role="alert">
                  {ui('ui_terms_empty_text', 'Content coming soon.')}
                </div>
              )}
          </div>
        )}
