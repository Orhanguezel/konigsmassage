// =============================================================
// FILE: src/components/containers/legal/PrivacyPolicyPageContent.tsx
// konigsmassage – Privacy Policy Content (SINGLE PAGE) (I18N + SAFE)
// Data: custom_pages (module_key="privacy") -> first published
// - Locale aware query
...
const PrivacyPolicyPageContent: React.FC = () => {
  ...
  const cmsFallbackCss = useMemo(
    () => `
      ...
      .cms-html .text-white\\/80 { color: rgba(255,255,255,.8) !important; }
      ...
      .cms-html .mb-10 { margin-bottom: 2.5rem !important; }
      ...
      .cms-html .bg-gradient-to-br { background-image: linear-gradient(135deg, #f8fafc, #eff6ff) !important; }
      .cms-html .from-slate-50 { }
      .cms-html .to-blue-50 { }
    `,
    [],
  );
          ...
          <div className="row">
            <div className="col-12">
              <div className="alert alert-warning">
                {ui('ui_privacy_policy_empty', 'Privacy policy content not found.')}
              </div>
            </div>
          </div>
        )}
              ...
              {html ? (
                ...
                <div className="alert alert-warning">
                  {ui(
                    ...
                    'Gizlilik politikası içeriği yakında yayınlanacaktır.',
                  )}
                </div>
              )}
