// =============================================================
// FILE: src/components/admin/footer-sections/FooterSectionsHeader.tsx
// Admin Footer Sections Header (filtreler + aksiyonlar)
...
export type FooterSectionOrderField = 'created_at' | 'updated_at' | 'display_order';

interface FooterSectionsHeaderProps {
  search: string;
  ...
  orderBy: FooterSectionOrderField;
  orderDir: 'asc' | 'desc';
  onOrderByChange: (v: FooterSectionOrderField) => void;
...
export const FooterSectionsHeader: React.FC<FooterSectionsHeaderProps> = ({
  search,
  onSearchChange,
  locale,
  onLocaleChange,
          ...
          <div className="card-body py-2">
            <div className="row g-2 align-items-end">
              ...
              <div className="col-12 col-md-4">
                <label className="form-label small mb-1">Ara (title / slug)</label>
                <input
                  type="text"
              ...
              <div className="col-6 col-md-3 mt-2">
                ...
                <div className="d-flex gap-1">
                  <select
                    className="form-select form-select-sm"
                    value={orderBy}
                    onChange={(e) => onOrderByChange(e.target.value as FooterSectionOrderField)}
                    disabled={loading}
                  >
            ...
            <div className="d-flex flex-wrap justify-content-between align-items-center gap-2">
              <div className="form-check form-switch small">
                <input
                  ...
                  type="checkbox"
                  id="footer-sections-header-active"
                  checked={!!showOnlyActive}
                  onChange={(e) => onShowOnlyActiveChange(e.target.checked)}
                  disabled={loading}
                />
                <label className="form-check-label ms-1" htmlFor="footer-sections-header-active">
                  Sadece aktifler
                </label>
              </div>
