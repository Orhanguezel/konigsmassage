...
// konigsmassage – Admin Menu Item Create / Edit Form (HEADER ONLY)
// =============================================================
  ...
  return (
    <div className="row g-3">
      ...
      <div className="col-md-3">
        <label className="form-label form-label-sm">
          Locale {localesLoading && <span className="spinner-border spinner-border-sm ms-1" />}
        </label>
        <select
      ...
      <div className="col-md-9">
        ...
        <input
          ...
          className="form-control form-control-sm"
          placeholder={
            values.type === 'custom' ? 'https://... veya /ornek' : 'Sayfa tipi için opsiyonel'
          }
          value={values.url}
      ...
      <div className="col-12">
        <div className="form-text small text-muted">
          <code>page_id</code>, <code>parent_id</code> ve <code>section_id</code> alanları gelişmiş
          kullanım içindir ve sadece <strong>JSON modunda</strong> düzenlenebilir.
        </div>
      </div>
    </div>
  );
